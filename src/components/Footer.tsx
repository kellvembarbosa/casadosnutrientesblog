                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                ...
                                <ul className="mt-4 space-y-4">
                                    <li><Link href="#" className="text-base leading-6 text-gray-400 hover:text-white">História</Link></li>
                                    <li><Link href="#" className="text-base leading-6 text-gray-400 hover:text-white">Equipe</Link></li>
                            ...
                            <div className="mt-12 md:mt-0">
                                ...
                                <ul className="mt-4 space-y-4">
                                    ...
                                    <li><Link href="#" className="text-base leading-6 text-gray-400 hover:text-white">Termos de serviço</Link></li>
